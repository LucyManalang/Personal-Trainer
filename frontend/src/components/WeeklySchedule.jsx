    ...
    return (
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
            <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold text-green-400">Week Ahead</h3>
                <button
                ...
                {[...Array(7)].map((_, i) => {
                    ...
                    return (
                        <div
                            ...
                            className={`p-3 rounded text-center border cursor-pointer transition hover:bg-gray-600/50 ${block ? 'border-gray-600 bg-gray-700/50' : 'border-dashed border-gray-700 bg-transparent'}`}
                        >
                            ...
                            {block ? (
                                <>
                                    <div className="font-bold text-sm text-white truncate">{block.type}</div>
                                    <div className="text-xs text-gray-400">{block.planned_duration_minutes} min</div>
                                </>
                            ) : (
